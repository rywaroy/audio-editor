...
type DOMNode = window.Node
type DOMComment = window.Comment
type DOMElement = window.Element
type DOMText = window.Text
type DOMRange = window.Range
type DOMSelection = window.Selection
type DOMStaticRange = window.StaticRange
